...
class PayService
{
    ...
    public function __construct($mchid, $appid, $appKey,$key)
    {
        ...
        $this->appKey = $appKey;
        $this->apiKey = $key;
        $this->apiclient_cert = "C:\inetpub\wwwroot\suyongCredit\public\apiclient_cert.pem";
        $this->apiclient_key = "C:\inetpub\wwwroot\suyongCredit\public\apiclient_key.pem";
    }
    /**
     * 拼接签名字符串
     * @param array $urlObj
