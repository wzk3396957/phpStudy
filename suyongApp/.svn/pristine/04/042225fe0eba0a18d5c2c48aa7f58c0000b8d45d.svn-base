...
class Api extends controller
{
    ...
    public function sendToClient(Request $request){
        if (!$request->post('id') or !$request->post('client_id') or !$request->post('client_ip')) {
            return 'request lost!';
        }

        Db::table('knight')->where('id',$request->post('id'))->update(['socket_id'=>$request->post('client_id'),'socket_ip'=>$request->post('client_ip')]);
    ...
    public function sendToClose(Request $request){
        ...
        Db::table('knight')->where('socket_id',$request->post('client_id'))->update(['socket_id'=>'']);
